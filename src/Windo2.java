 ...
 * @author Murad
 */
public class Windo2 extends javax.swing.JFrame {
 String s;
    String f1="0", f2="0", f3="0", f4="0", f5="0", f6="0", f7="0", f8="0", f9="0";
    ...
    public Windo2() {
     ...
     void check() {
        ...
        if (!jTextField4.getText().isEmpty()) {
            f4 = jTextField4.getText();
        }
        if (!jTextField5.getText().isEmpty()) {
            f5 = jTextField5.getText();
        }
        if (!jTextField6.getText().isEmpty()) {
            f6 = jTextField6.getText();
        }
        if (!jTextField7.getText().isEmpty()) {
            f7 = jTextField7.getText();
        }
        if (!jTextField8.getText().isEmpty()) {
            f8 = jTextField8.getText();
        }
        if (!jTextField9.getText().isEmpty()) {
            f9 = jTextField9.getText();
        }
        a1 = Integer.parseInt(f1);
        a2 = Integer.parseInt(f2);
        a3 = Integer.parseInt(f3);
        a4 = Integer.parseInt(f4);
        a5 = Integer.parseInt(f5);
        a6 = Integer.parseInt(f6);
        a7 = Integer.parseInt(f7);
        a8 = Integer.parseInt(f8);
        a9 = Integer.parseInt(f9);
        
        if ((a1 + a2 + a3 == 15) && (a4 + a5 + a6 == 15) && (a7 + a8 + a9 == 15)&&(a1 + a4 + a7 == 15)&&
                (a2 + a5 + a8 == 15)&&(a3 + a6 + a9 == 15)&&(a1 + a5 + a9 == 15)&&(a3 + a5 + a7 == 15)) {
            JOptionPane.showMessageDialog(this, "DAMN,YOU WON");
        }
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(69, 69, 69)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(reset, javax.swing.GroupLayout.DEFAULT_SIZE, 107, Short.MAX_VALUE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Windo2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
